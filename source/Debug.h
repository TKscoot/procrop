...
class Debug
{
  ...
  public:
    ...
    ///
    template <typename T> static void Log(T &msg)
    {
    ...
    ///
    template <typename T> static void Critical(T &msg)
    {
    ...
    ///
    template <typename T> static void CoreLog(T &msg)
    {
    ...
    ///
    template <typename T> static void CoreInfo(T &msg)
    {
    ...
    ///
    template <typename T> static void CoreWarning(T &msg)
    {
    ...
    ///
    template <typename T> static void CoreError(T &msg)
    {
    ...
    ///
    template <typename T> static void CoreCritical(T &msg)
    {
    ...
    /// Prints white trace message to stdout
    ///
    template <typename FormatString, typename... Args> static void Log(const FormatString &fmt, const Args &...args)
    {
    ...
    /// Prints green info message to stdout
    ///
    template <typename FormatString, typename... Args> static void Info(const FormatString &fmt, const Args &...args)
    {
    ...
    /// Prints yellow warning message to stdout
    ///
    template <typename FormatString, typename... Args> static void Warning(const FormatString &fmt, const Args &...args)
    {
    ...
    /// Prints red error message to stdout
    ///
    template <typename FormatString, typename... Args> static void Error(const FormatString &fmt, const Args &...args)
    {
    ...
    /// Prints uncolored (white) core/engine message to stdout
    ///
    template <typename FormatString, typename... Args> static void CoreLog(const FormatString &fmt, const Args &...args)
    {
